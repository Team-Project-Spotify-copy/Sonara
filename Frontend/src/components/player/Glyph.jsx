...
/*
  Мінімальні гліфи всередині кружків із макета; геометрію кнопок не змінюють.
  Набір навмисно приватний для модуля: якби він експортувався поруч із
  компонентом, Fast Refresh перезавантажував би сторінку цілком (і обривав
  відтворення) на кожну правку іконки.
*/
const PATHS = {
  play: "M4 2v20l17-10z",
