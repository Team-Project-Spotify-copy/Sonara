...
public static class SeedDataExtension
{
    public static void Seed(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Subscription>().HasData(
            new Subscription { Id = subFreeGuid, Name = "Free", Price = 0.00m, Features = "Ads included, Audio standard quality, Shuffle only" },
            new Subscription { Id = subPremiumGuid, Name = "Premium", Price = 4.99m, Features = "No ads, High quality audio, Offline downloads" },
        ...
        modelBuilder.Entity<User>().HasData(
            new User { Id = userGuids[0], Username = "john_doe", AvatarUrl = "https://sonarastorage.blob.core.windows.net/images/avatars/avatar_1.jpg", Email = "john@example.com", PasswordHash = defaultPasswordHash, RoleId = roleAdminGuid, SubscriptionId = subPremiumGuid, CreatedAt = seedDate },
            new User { Id = userGuids[1], Username = "alex_sound", AvatarUrl = "https://sonarastorage.blob.core.windows.net/images/avatars/avatar_2.jpg", Email = "alex@example.com", PasswordHash = defaultPasswordHash, RoleId = roleUserGuid, SubscriptionId = subPremiumGuid, CreatedAt = seedDate },
            new User { Id = userGuids[2], Username = "maria_keys", AvatarUrl = "https://sonarastorage.blob.core.windows.net/images/avatars/avatar_3.jpg", Email = "maria@example.com", PasswordHash = defaultPasswordHash, RoleId = roleUserGuid, SubscriptionId = subFamilyGuid, CreatedAt = seedDate },
            new User { Id = userGuids[3], Username = "listener99", AvatarUrl = "https://sonarastorage.blob.core.windows.net/images/avatars/avatar_4.jpg", Email = "listener@example.com", PasswordHash = defaultPasswordHash, RoleId = roleUserGuid, SubscriptionId = subFreeGuid, CreatedAt = seedDate },
