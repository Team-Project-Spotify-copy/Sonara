...
public interface IPlaylistService
{
    ...
    Task<PlaylistDto> GetByNameAsync(string playlistName, Guid? requestingUserId, CancellationToken ct = default);
    ...
    Task<PlaylistDto> AddTrackAsync(Guid playlistId, Guid ownerId, string trackName, CancellationToken ct = default);
