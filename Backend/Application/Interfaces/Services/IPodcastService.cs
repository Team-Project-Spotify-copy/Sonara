...
public interface IPodcastService
{
    ...
    Task<PodcastDetailsDto?> GetByIdAsync(Guid id, Guid currentUserId, CancellationToken ct = default);
    Task<PodcastDetailsDto?> GetByNameAsync(string podcastName, Guid currentUserId, CancellationToken ct = default);
